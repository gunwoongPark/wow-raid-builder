...
- **Blizzard** — 캐릭터 정보, 아이템 레벨 (OAuth Client Credentials)
- **Raider.IO** — M+ 점수, 공격대 진행도
- **Warcraft Logs** — 레이드 로그 퍼센트
